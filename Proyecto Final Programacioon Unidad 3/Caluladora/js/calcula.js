...
function hexaOctal() {
        x=parseInt(x);
        pantalla.innerHTML="Hexadecimal: " + x.toString(8) + " Octal: " + x.toString(16);
         }
function porcent() { 
...
function retro(){ //Borrar sólo el último número escrito.
         ...
         br=x.substr(cifras-1,0) //describir último caracter
...
function borradoParcial() {
        ...
        var newHistorial = document.createTextNode((con ++) + ".- " + sl + " = " + x);
        historial.appendChild(newHistorial);

        var currentDiv = document.getElementById("Historial");
